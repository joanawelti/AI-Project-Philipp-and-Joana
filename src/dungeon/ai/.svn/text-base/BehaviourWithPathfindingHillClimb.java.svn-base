...
import dungeon.ai.pathfind.PathFindBestFirst;
import dungeon.ai.pathfind.PathFindDepth;
import dungeon.ai.pathfind.PathFindHillClimb;
import dungeon.model.Game;
import dungeon.model.items.mobs.Creature;
import dungeon.ui.MapPanel;

public abstract class BehaviourWithPathfindingHillClimb implements Behaviour {
	...
	public BehaviourWithPathfindingHillClimb(Creature creature){
	fCreature = creature;
	followAction = new PathFindHillClimb(creature);}
