...
public abstract class BehaviourWithPathfindingBestFirst implements Behaviour {
	...
	public BehaviourWithPathfindingBestFirst(Creature creature){
	fCreature = creature;
	followAction = new PathFindBestFirst(creature);}
