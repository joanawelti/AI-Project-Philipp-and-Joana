...
public abstract class BehaviourWithPathfindingDepth implements Behaviour {
	...
	public BehaviourWithPathfindingDepth(Creature creature){
	fCreature = creature;
	followAction = new PathFindDepth(creature);}
